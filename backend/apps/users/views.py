...
from .serializers import (
    ...
    UserListSerializer, AdminUserSerializer
)
...
class ApproveMentorView(APIView):
    ...
    def post(self, request, pk):
        try:
            user = User.objects.get(pk=pk, role='MENTOR')
        ...
        user.save()
        return Response({'message': f'Mentor {user.username} approved.'})


class MentorListView(generics.ListAPIView):
    """Public: list approved mentors."""
